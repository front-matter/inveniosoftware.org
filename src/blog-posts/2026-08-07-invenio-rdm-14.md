...
See the [full release notes](https://inveniordm.docs.cern.ch/releases/v14/version-v14.0/) for *all* the details, and the [upgrade guide](https://inveniordm.docs.cern.ch/releases/v14/upgrade-v14.0/) for instructions on how to upgrade from your v13 instance to v14.
